...
<head>
    ...
    <title>Résultats de la Eredivisie</title>
...
<body>
    <h1>Eredivisie</h1>
    <div id="standings">
        <!-- Tableau des résultats de la Eredivisie -->
        <table border="1">
            <tr>
                <th>Club</th>
                <th></th>
    ...
    <script>
        ...
        const apiUrl = '../FootProxy.php?url=<?php echo urlencode($DEDapiUrl); ?>&key=<?php echo urlencode($apiKey); ?>';
