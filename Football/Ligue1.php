...
<head>
    ...
    <title>Résultats de la Ligue 1</title>
...
<body>
    <h1>Ligue 1</h1>
    <div id="standings">
        <!-- Tableau des résultats de la Ligue 1 -->
        <table border="1">
            <tr>
                <th>Club</th>
                <th></th>
    ...
    <script>
        ...
        const apiUrl = '../FootProxy.php?url=<?php echo urlencode($FL1apiUrl); ?>&key=<?php echo urlencode($apiKey); ?>';
