...
<head>
    ...
    <title>Résultats de la Liga</title>
...
<body>
    <h1>Liga</h1>
    <div id="standings">
        <!-- Tableau des résultats de la Liga -->
        <table border="1">
            <tr>
                <th>Club</th>
                <th></th>
    ...
    <script>
        ...
        const apiUrl = '../FootProxy.php?url=<?php echo urlencode($PDapiUrl); ?>&key=<?php echo urlencode($apiKey); ?>';
