...
<head>
    ...
    <title>Résultats de la Bundesliga</title>
...
<body>
    <h1>Bundesliga</h1>
    <div id="standings">
        <!-- Tableau des résultats de la Bundesliga -->
        <table border="1">
            <tr>
                <th>Club</th>
                <th></th>
    ...
    <script>
        ...
        const apiUrl = '../FootProxy.php?url=<?php echo urlencode($BL1apiUrl); ?>&key=<?php echo urlencode($apiKey); ?>';
